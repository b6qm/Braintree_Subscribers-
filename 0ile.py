...
if check_authorized(user):
    ...
    print("غير مصرح لك بتشغيل هذه الأداة.")
    print('Tσσℓѕ Sтσρрє∂ ')
    print('لا تحاول تسحب روابط | Protect By ModcaPy | ~ @B_6_Q ~ ')
    print('< 𝗠𝗼𝗱𝗰𝗮 𓏺 𝗧𝗵𝗲 𝗟𝗼𝘀𝘁 🇬🇧 > @B_6_Q')
...
try:
	...
	print("- 𝗠σ𝗗υℓє 𝗘яяσя • انت غير مثبت المكتبة المطلوبة جاري تثبيتها..")
	os.system('pip install user_agent')
#webbrowser.open('https://t.me/+UO1DPQYFMcpkY2Y0')
...
for P in file.readlines():
    ...
    headers = {
        ...
        'authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiIsImtpZCI6IjIwMTgwNDI2MTYtcHJvZHVjdGlvbiIsImlzcyI6Imh0dHBzOi8vYXBpLmJyYWludHJlZWdhdGV3YXkuY29tIn0..a05xqrqD1SRLeqDHiGau7T_qRq_7_COPNkF7Oa8S8FmVCy1yyk80VtSrDnhaCdr0gywFxSYSja0Qc7z8sgu1TA',
    ...
    json_data = {
        'clientSdkMetadata': {
            'source': 'client',
            'integration': 'custom',
            'sessionId': 'adceb70c-ba79-4923-995f-ee4b5764b4f1',
        },
    ...
    cookies = {
        ...
        'osVisit': '4bded4e4-8b7c-4d2d-8cb0-6b34d9c069dd',
        'nlbi_2624039': 'Qz2OP/R8ODViu0Csnrr3FQAAAABKtHXaF2oI/r/N0hDyVTae',
        'incap_ses_1173_2624039': 'VSszWdHcTCycwVCgflVHEJ5XUWcAAAAAWl4UwuyJjxYxHLpE0jF3bA==',
        'ASP.NET_SessionId': 'pjnzme3xhvwxsnrzlr1f44fy',
        '_ga_WSCFS5WWZ0': 'GS1.1.1733384101.19.0.1733384101.0.0.0',
        'incap_ses_188_2624039': '9iG3IJs71CHzYnhGNOmbAqFaUWcAAAAAHb18ZgcBEt4jHneBLHJqgw==',
        'nr1ApolloUser_CS': 'lid%3dup8g6a3gUUr2r4Cd1I%2btqQ%3d%3d0LWNjxz81NGX12YtygTBxg%3d%3d%3btuu%3d63868981969%3bexp%3d63871573669%3brhs%3dqmqs21oSCQNMIa57tnJPUgE%2bd9A%3d%3bhmc%3dVIE326X1Pc0Duy6u%2fJ%2fjn8D%2b4jw%3d',
    }
